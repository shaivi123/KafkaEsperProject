...
public class EPLUtil {
    ...
    public static EPCompiled compileEPL(Configuration myConfiguration, String statement, String name) {
        ...
        EPCompiled compiled;
        try {
            compiled = EPCompilerProvider.getCompiler().compile(finalStatement, new CompilerArguments(myConfiguration));
